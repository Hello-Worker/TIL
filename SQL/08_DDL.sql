...
create table parent_tb(
    ...
    email varchar2(100) constraint uk_parent_tb_email unique, -- unique제약조건: 중복된 값이 들어갈 수 없다. (null제외)
...
--rollback/commit--DML; ddl문은 rollback /commit 대상이 아니다.
desc cust;
...
insert into dept_copy values(dept_id_seq2.nextval, '구매부', '서울');
insert into dept_copy values(dept_id_seq2.nextval, '개발부', '서울');
