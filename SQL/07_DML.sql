...
rollback; --insert/update/delete하기 전 상태로 돌려라.(마지막 commit 상태로 돌려준다.)
...
insert into emp values (1500, null, 'FI_ACCOUNT', 100, '2021/01/06', 1000, 0.1, 20);--not null 컬럼에 null을 넣을 수없다.
insert into emp values (1000, '김영수', '회계', 100, '2021/01/06', 1000, 0.1, 20); --emp의 job_id 는 FK 컬럼 -> 부모테이블(job)의 PK 컬럼(job_id)에 있는 값만 넣을 수 있다.
...
delete from emp, dept;--한 테이블 단위로만 처리
