...
insert into member values ('id-3','11111', '장영수', 10000, '2013/07/07');--pk는 기존에 있는 값을 넣을 수 없다.
insert into member values ('id-4', '11111', '박영희', 10000, '2013/07/07');
insert into member values ('id-5', '11111', '박영희', null, '2013/07/07'); --null: 값이 없다. name:not null이기 때문에 null을 넣을 수 없다.
                                                                          --point는 nullable이므로 null값을 넣을 수 있다.
